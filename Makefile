# Makefile for building all MCP25xxx-Multi-IDF-CAN examples
...
build:
	@echo "$(BLUE)========================================"
	@echo "Building all MCP25xxx-Multi-IDF-CAN examples"
	@echo "========================================$(NC)"
...
clean:
	@echo "$(BLUE)========================================"
	@echo "Cleaning all MCP25xxx-Multi-IDF-CAN examples"
	@echo "========================================$(NC)"
	@for example in $(EXAMPLES); do \
...
# Help target
help:
	@echo "$(BLUE)MCP25xxx-Multi-IDF-CAN Examples Build System$(NC)"
	@echo ""
